...
export function RocketIcon({ size = 20, className = "" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M13 15l1.5-1.5L22 3l-10.5 7.5L10 12l3 3z" />
      <path d="M16 8l-6 6.5L7 12l2-3.5L16 8z" />
      <path d="M9 15l-3.5 2L3 14l6.5-3L9 15z" />
    </svg>
  );
}
...
export function BrainIcon({ size = 20, className = "" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96-.44 2.5 2.5 0 0 1 0-3.08 2.5 2.5 0 0 1 0-3.08 2.5 2.5 0 0 1 0-3.08A2.5 2.5 0 0 1 9.5 2z" />
      <path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96-.44 2.5 2.5 0 0 0 0-3.08 2.5 2.5 0 0 0 0-3.08 2.5 2.5 0 0 0 0-3.08A2.5 2.5 0 0 0 14.5 2z" />
    </svg>
  );
}
...
export function WalletIcon({ size = 20, className = "" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M22 10.3c0-1.8-1.5-2.3-3.3-2.3H5.3C3.5 8 2 8.5 2 10.3" />
    </svg>
  );
}
...
export function PaintIcon({ size = 20, className = "" }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 11.5 21.5 11 21 11H12.5C11.6716 11 11 10.3284 11 9.5V2C11 1.5 10.5 1 10 1C4.47715 1 0 5.47715 0 11C0 16.5228 4.47715 22 10 22H12Z" />
